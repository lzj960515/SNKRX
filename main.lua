...
function init()
  ...
  character_class_strings = {
    ['vagrant'] = '[fg]探险者, 灵能者',
    ['swordsman'] = '[yellow]战士',
    ['wizard'] = '[blue]法师, [red]爆发者',
    ['magician'] = '[blue]法师',
    ['archer'] = '[green]射手',
    ['scout'] = '[red]盗贼',
    ['cleric'] = '[green]治疗者',
    ['outlaw'] = '[yellow]战士, [red]盗贼',
    ['blade'] = '[yellow]战士, [red]爆发者',
    ['elementor'] = '[blue]法师, [red]爆发者',
    -- ['saboteur'] = '[red]盗贼, [orange]召唤者, [red]爆发者',
    ['bomber'] = '[red]爆发者, [orange]建造者',
    ['stormweaver'] = '[blue]增益者',
    ['sage'] = '[red]爆发者, [yellow]力场者',
    ['squire'] = '[yellow]战士, [blue]增益者',
    ['cannoneer'] = '[green]射手, [red]爆发者',
    ['dual_gunner'] = '[green]射手, [red]盗贼',
    -- ['hunter'] = '[green]射手, [orange]召唤者, [yellow]力场者',
    ['sentry'] = '[green]射手, [orange]建造者',
    ['chronomancer'] = '[blue]法师, 增益者',
    ['spellblade'] = '[blue]法师, [red]盗贼',
    ['psykeeper'] = '[green]治疗者, [fg]灵能者',
    ['engineer'] = '[orange]建造者',
    ['plague_doctor'] = '[red]爆发者, [purple]虚空者',
    ['barbarian'] = '[purple]诅咒者, [yellow]战士',
    ['juggernaut'] = '[yellow]力场者, 战士',
    ['lich'] = '[blue]法师',
    ['cryomancer'] = '[blue]法师, [purple]虚空者',
    ['pyromancer'] = '[blue]法师, [red]爆发者, [purple]虚空者',
    ['corruptor'] = '[green]射手, [orange]召集者',
    ['beastmaster'] = '[red]盗贼, [orange]召集者',
    ['launcher'] = '[yellow]力场者, [purple]诅咒者',
    ['jester'] = '[purple]诅咒者, [red]盗贼',
    ['assassin'] = '[red]盗贼, [purple]虚空者',
    ['host'] = '[orange]召集者',
    ['carver'] = '[orange]建造者, [green]治疗者',
    ['bane'] = '[purple]诅咒者, 虚空者',
    ['psykino'] = '[blue]法师, [fg]灵能者, [yellow]力场者',
    ['barrager'] = '[green]射手, [yellow]力场者',
    ['highlander'] = '[yellow]战士',
    ['fairy'] = '[blue]增益者, [green]治疗者',
    ['priest'] = '[green]治疗者',
    ['infestor'] = '[purple]诅咒者, [orange]召集者',
    ['flagellant'] = '[fg]灵能者, [blue]增益者',
    ['arcanist'] = '[blue2]巫师',
    -- ['illusionist'] = '[blue2]巫师, [orange]召唤者',
    ['artificer'] = '[blue2]巫师, [orange]建造者',
    ['witch'] = '[blue2]巫师, [purple]虚空者',
    ['silencer'] = '[blue2]巫师, [purple]诅咒者',
    ['vulcanist'] = '[blue2]巫师, [red]爆发者',
    ['warden'] = '[blue2]巫师, [yellow]力场者',
    ['psychic'] = '[blue2]巫师, [fg]灵能者',
    ['miner'] = '[yellow2]佣兵',
    ['merchant'] = '[yellow2]佣兵',
    ['usurer'] = '[purple]诅咒者, [yellow2]佣兵, [purple]虚空者',
  ...
  character_effect_names = {
    ...
    ['bomber'] = '[orange]爆破专家',
    ['stormweaver'] = '[blue]宽幅闪电',
    ['sage'] = '[purple]维度压缩',
    ['squire'] = '[yellow]闪亮装备',
    ['cannoneer'] = '[orange]炮击弹幕',
    ['dual_gunner'] = '[green]枪械技巧',
    ['hunter'] = '[green]野性群体',
    ['sentry'] = '[green]哨兵弹幕',
    ...
    ['launcher'] = '[orange]动能',
    ['jester'] = "[red]大混乱",
    ['assassin'] = '[purple]毒性投递',
    ['host'] = '[orange]入侵',
    ['carver'] = '[green]世界树',
    ['bane'] = '[purple]噩梦',
    ['psykino'] = '[fg]磁力',
    ['barrager'] = '[green]弹幕',
    ['highlander'] = '[yellow]剑花',
    ['fairy'] = '[green]奇思妙想',
    ['priest'] = '[green]神圣干预',
    ['infestor'] = '[orange]感染',
    ['flagellant'] = '[red]狂热',
  ...
  passive_names = {
    ['centipede'] = '蜈蚣',
    ['ouroboros_technique_r'] = '衔尾蛇技巧 右',
    ['ouroboros_technique_l'] = '衔尾蛇技巧 左',
    ['amplify'] = '增幅',
    ['resonance'] = '共鸣',
    ['ballista'] = '弩炮',
    ['call_of_the_void'] = '虚空呼唤',
    ['crucio'] = '钻心',
    ['speed_3'] = '速度 3',
    ['damage_4'] = '伤害 4',
    ['shoot_5'] = '射击 5',
    ...
    ['dividends'] = '红利',
    ['berserking'] = '狂暴',
    ['unwavering_stance'] = '不屈姿态',
    ['unrelenting_stance'] = '无情姿态',
    ['blessing'] = '祝福',
    ['haste'] = '急速',
    ['divine_barrage'] = '神圣弹幕',
    ['orbitism'] = '轨道运动',
    ...
    ['rearm'] = '重装',
    ['taunt'] = '嘲讽',
    ['construct_instability'] = '构造不稳定性',
    ['intimidation'] = '恐吓',
    ['vulnerability'] = '弱点',
    ['temporal_chains'] = '时空锁链',
  ...
  passive_descriptions = {
    ...
    ['kinetic_bomb'] = '[fg]友军死亡时爆炸,击退敌人',
    ['porcupine_technique'] = '[fg]友军死亡时爆炸,释放穿透和弹射的投射物',
    ...
    ['annihilation'] = '[fg]虚空使者死亡时对所有敌人造成其持续伤害,持续 [yellow]3[fg] 秒',
    ...
    ['freezing_field'] = '[fg]巫师重复施法时创造一个区域,使敌人减速 [yellow]50%[fg],持续 [yellow]2[fg] 秒',
    ['burning_field'] = '[fg]巫师重复施法时创造一个区域,每秒造成 [yellow]30[fg] 点伤害,持续 [yellow]2[fg] 秒',
    ['gravity_field'] = '[fg]巫师重复施法时创造一个区域,将敌人吸引,持续 [yellow]1[fg] 秒',
  ...
  passive_descriptions_level = {
    ...
    ['freezing_field'] = function(lvl) return '[fg]巫师重复施法时创造一个区域,使敌人减速 [yellow]50%[fg],持续 [yellow]2[fg] 秒' end,
    ['burning_field'] = function(lvl) return '[fg]巫师重复施法时创造一个区域,每秒造成 [yellow]30[fg] 点伤害,持续 [yellow]2[fg] 秒' end,
    ['gravity_field'] = function(lvl) return '[fg]巫师重复施法时创造一个区域,将敌人吸引,持续 [yellow]1[fg] 秒' end,
